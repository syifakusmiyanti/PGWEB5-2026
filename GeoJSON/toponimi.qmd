...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link type="ArcSDE Connection" description="" name="SDE Feature Class" mimeType="" format="" size="" url="Server=gisserver_skala_250K; Service=sde:sqlserver:gisserver\skala_250K; Database=Indonesia_250K; Version=dbo.DEFAULT"/>
  </links>
  <dates/>
  <fees></fees>
